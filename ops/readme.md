...
docker tag prr-web-admin baio/prr-web-admin:v0.10
docker push baio/prr-web-admin:v0.10
```
---
```
...
docker tag prr-api baio/prr-api:v0.17
docker push baio/prr-api:v0.17
```
