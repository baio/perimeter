...
docker tag prr-web-admin baio/prr-web-admin:v0.7
docker push baio/prr-web-admin:v0.7
```
---
```
...
docker tag prr-api baio/prr-api:v0.14
docker push baio/prr-api:v0.14
```
