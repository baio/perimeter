...
docker tag prr-web-admin baio/prr-web-admin:v0.6
docker push baio/prr-web-admin:v0.6
```
---
```
...
docker tag prr-api baio/prr-api:v0.13
docker push baio/prr-api:v0.13
```
