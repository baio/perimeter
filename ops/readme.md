...
docker tag prr-web-admin baio/prr-web-admin:v0.9
docker push baio/prr-web-admin:v0.9
```
---
```
...
docker tag prr-api baio/prr-api:v0.15
docker push baio/prr-api:v0.15
```
