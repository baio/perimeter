...
docker tag prr-web-admin baio/prr-web-admin:v0.12
docker push baio/prr-web-admin:v0.12
```
---
```
...
docker tag prr-api baio/prr-api:v0.20
docker push baio/prr-api:v0.20
```
